...
class KoealustaService(
    ...
    private val kielitestiSuoritusErrorsRepository: KielitestiSuoritusErrorsRepository,
) {
    ...
    fun importSuoritukset(from: Instant) =
        logger
            ...
            .withEventAndPerformanceCheck { event ->
                ...
                kielitestiSuoritusErrorsRepository.saveAll(mappingService.convertErrors(validationErrors))
