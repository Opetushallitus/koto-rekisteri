...
interface CustomYkiSuoritusRepository {
    ...
    fun findAllOrdered(orderBy: String = "arviointipaiva"): Iterable<YkiSuoritusEntity>

    fun findAllDistinct(orderBy: String = "arviointipaiva"): Iterable<YkiSuoritusEntity>
}
